package com.cml.androidlcmlsenioranimation.demo.demo.demo9;
...
public class Demo9View extends View {
    ...
    public Demo9View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Demo9View(Context context, AttributeSet attrs, int defStyleAttr) {
